...
load_dotenv()
from remote.util.config.config import Settings
...
settings = Settings(r"C:\Users\Cristopher Hdz\Desktop\ai_portal\remote\util\config\config.yaml")

logging.basicConfig(level=logging.DEBUG)
logger = logging.getLogger(name=f'MCP_HOST.{__name__}')
...
with open(r"C:\Users\Cristopher Hdz\Desktop\ai_portal\remote\util\config\servers.json",'r') as config:
    data = config.read()
